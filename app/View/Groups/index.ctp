<div class="groups index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('group_contractor'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($group['Group']['group_code']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['group_name']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['contact']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['remarks']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['group_contractor']); ?>&nbsp;</td>
